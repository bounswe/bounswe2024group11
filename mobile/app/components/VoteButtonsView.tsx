...
const VoteButtonsView: React.FC<VoteButtonViewsProps> = ({ is_upvoted, upvotes_count, is_downvoted, downvotes_count }) => {
    return (
        <View style={styles.container}>
            <TouchableOpacity style={[
                styles.iconButton,
                is_upvoted && styles.upvotedButton
            ]}>
            ...
            <TouchableOpacity style={[
                styles.iconButton,
                is_downvoted && styles.downvotedButton
            ]}>
